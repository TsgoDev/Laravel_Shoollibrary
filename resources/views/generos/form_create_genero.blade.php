...
<div id="crud-modal-create" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow-sm white:bg-gray-700">
            ...
            <!-- Modal body -->
            <form class="p-4 md:p-5" action="{{ route('generos-store') }}" method="POST"
                enctype="multipart/form-data">
                @csrf
                <div class="grid gap-4 mb-6 grid-cols-2">
                    <div class="col-span-2">
                        <label for="nome_genero" class="block mb-2 text-sm font-medium text-gray-900 white:text-white">Nome do gênero</label>
                        <input type="text" name="nome_genero" id="nome_genero"
                            ...
                            required="" maxlength="100" placeholder="Ex: Romance" autocomplete="nome_genero">
                    </div>

                    <!-- Situacao do Genero -->
                    <div class="col-span-2">
                        <label for="status_genero" class="block mb-2 text-sm font-medium text-gray-900 white:text-white">Status</label>
                        <select id="status_genero" name="status_genero" class="bg-white text-black border

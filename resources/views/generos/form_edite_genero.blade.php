...
<div id="crud-modal-edit" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow-sm white:bg-gray-700">
            ...
            <!-- Modal de Edição -->
            <form id="form-editar-genero" action="" method="POST" class="p-4 md:p-5" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="grid gap-4 mb-6 grid-cols-2">
                    ...
                    <div class="col-span-2">
                        <label for="genero" class="block mb-2 text-sm font-medium text-gray-900 white:text-white">
                            Nome do gênero
                        </label>
                    ...
                    <div class="col-span-2">
                        ...
                        <select id="status_genero" name="status_genero"
